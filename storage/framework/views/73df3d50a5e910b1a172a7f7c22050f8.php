...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="meeting-link-container">
                    ...
                    <input type="url" name="meeting_link" id="meeting_link" value="<?php echo e(old('meeting_link', $event->meeting_link ?? '')); ?>"
                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm admin-input <?php $__errorArgs = ['meeting_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Study\Kuliah\Semester-7\CP\event-connect\resources\views/admin/events/edit.blade.php ENDPATH**/ ?>