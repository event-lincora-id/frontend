<?php $__env->startSection('title', 'Panduan Penggunaan - Event Connect'); ?>
            ...
            <div class="flex flex-col lg:flex-row gap-10 items-center">
                ...
                <div class="flex-1">
                    <div class="bg-gradient-to-br from-white to-red-50 border border-red-100 rounded-2xl p-8 shadow-lg">
                        ...
                        <div class="mt-6">
                            <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center gap-2 bg-red-600 text-white px-5 py-3 rounded-md font-semibold hover:bg-red-700 transition">
            ...
            <div class="flex flex-col lg:flex-row gap-10 items-center">
                ...
                <div class="flex-1 order-1 lg:order-2">
                    <div class="bg-red-700 text-white rounded-2xl p-8 shadow-2xl">
                        ...
                        <div class="mt-8">
                            <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-2 bg-white text-red-700 px-6 py-3 rounded-md font-semibold hover:bg-white/90 transition">
    ...
    <section class="bg-red-700 text-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            ...
            <div class="flex flex-col md:flex-row justify-center gap-4">
                <a href="<?php echo e(route('register')); ?>" class="bg-white text-red-700 font-semibold px-6 py-3 rounded-md shadow hover:bg-white/90 transition">
                    Daftar Sekarang
                </a>
                <a href="<?php echo e(route('login')); ?>" class="bg-transparent border border-white text-white font-semibold px-6 py-3 rounded-md hover:bg-white/10 transition">
                    Masuk ke Akun
                </a>
            </div>
        </div>
...
<?php echo $__env->make('participant.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\frontend\resources\views/guide.blade.php ENDPATH**/ ?>