...
<body class="bg-gray-50">
                ...
                <?php if($participant && $event): ?>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900"><?php echo e(\Carbon\Carbon::parse($event->start_date)->format('M d, Y H:i')); ?></span>
                            </div>
                            
                            <div class="flex justify-between">
                                <span class="text-gray-600">Location:</span>
                                <span class="font-medium text-gray-900"><?php echo e($event->location); ?></span>
                            </div>
                            
                            <div class="flex justify-between">
                                <span class="text-gray-600">Amount Paid:</span>
                                <span class="font-medium text-green-600">Rp <?php echo e(number_format($participant->amount_paid ?? $event->price)); ?></span>
                            </div>
                    ...
                    <?php if($participant->payment_reference): ?>
                        <div class="bg-gray-50 rounded-lg p-4 mb-6">
                            ...
                            <p class="font-mono text-sm text-gray-900"><?php echo e($participant->payment_reference); ?></p>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Verifying payment status for participant <?php echo e($participant->id); ?>...');

            fetch('<?php echo e(env("API_BASE_URL")); ?>/payments/status/<?php echo e($participant->id); ?>', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
                    'Authorization': 'Bearer <?php echo e(Session::get("api_token")); ?>'
                }
            })
        ...
        setTimeout(function() {
            <?php if(auth()->check()): ?>
                window.location.href = "<?php echo e(route('participant.dashboard')); ?>";
            <?php else: ?>
...
<?php /**PATH C:\Study\Kuliah\Semester-7\CP\event-connect\resources\views/payments/success.blade.php ENDPATH**/ ?>