...
<?php $__env->startSection('title', 'Platform Management Dashboard'); ?>
<?php $__env->startSection('page-title', 'Platform Dashboard'); ?>
<?php $__env->startSection('page-description', 'Monitor all event organizers and events across the Event Connect platform'); ?>
    ...
    <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-md border-l-4 border-blue-500 p-4 md:p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl md:text-3xl font-bold text-blue-900 mt-1"><?php echo e(number_format($stats['total_organizers'] ?? 0)); ?></p>
    ...
    <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow-md border-l-4 border-purple-500 p-4 md:p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl md:text-3xl font-bold text-purple-900 mt-1"><?php echo e(number_format($stats['total_events'] ?? 0)); ?></p>
    ...
    <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow-md border-l-4 border-green-500 p-4 md:p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl md:text-3xl font-bold text-green-900 mt-1"><?php echo e(number_format($stats['total_participants'] ?? 0)); ?></p>
    ...
    <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg shadow-md border-l-4 border-amber-500 p-4 md:p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xl md:text-2xl font-bold text-amber-900 mt-1">Rp <?php echo e(number_format($stats['total_revenue'] ?? 0)); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
    <div class="bg-white rounded-lg shadow p-4 md:p-6">
        ...
        <div class="space-y-3">
            ...
            ?>
            <?php $__currentLoopData = $stats['event_breakdown'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $color = $statusColors[$status] ?? ['bg' => 'bg-gray-50', 'text' => 'text-gray-700', 'border' => 'border-l-4 border-gray-500', 'icon' => 'calendar']; ?>
                <div class="flex items-center justify-between p-3 <?php echo e($color['bg']); ?> <?php echo e($color['border']); ?> rounded">
                    <div class="flex items-center">
                        <i class="fas fa-<?php echo e($color['icon']); ?> <?php echo e($color['text']); ?> mr-3"></i>
                        <span class="font-medium <?php echo e($color['text']); ?>"><?php echo e(ucfirst($status)); ?></span>
                    </div>
                    <span class="font-bold text-lg <?php echo e($color['text']); ?>"><?php echo e(number_format($count)); ?></span>
                </div>
    ...
    <div class="bg-white rounded-lg shadow p-4 md:p-6">
        ...
        <div class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $stats['top_organizers'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organizer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <p class="font-medium text-gray-900"><?php echo e($organizer['name'] ?? 'Unknown'); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e($organizer['email'] ?? ''); ?></p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="font-bold text-blue-600"><?php echo e(number_format($organizer['events_count'] ?? 0)); ?></p>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
    <a href="<?php echo e(route('super.admin.organizers')); ?>" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow border-t-4 border-blue-500">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 font-medium">Manage Organizers</p>
                <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e(number_format($stats['total_organizers'] ?? 0)); ?></p>
            </div>
            <i class="fas fa-crown text-3xl text-blue-200"></i>
        </div>
    </a>

    <a href="<?php echo e(route('super.admin.events')); ?>" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow border-t-4 border-purple-500">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 font-medium">Monitor Events</p>
                <p class="text-2xl font-bold text-purple-600 mt-1"><?php echo e(number_format($stats['total_events'] ?? 0)); ?></p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 border-t-4 border-green-500">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xl font-bold text-green-600 mt-1">Rp <?php echo e(number_format(floor(($stats['total_revenue'] ?? 0) / 1000000))); ?>M</p>
            </div>
    ...
    new Chart(categoryCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: <?php echo json_encode(array_slice($categoryColors, 0, count($categoryNames))); ?>,
                borderColor: '#fff',
                borderWidth: 2
            }]
        },
...
<?php echo $__env->make('admin.super-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\frontend\resources\views/admin/super/dashboard.blade.php ENDPATH**/ ?>