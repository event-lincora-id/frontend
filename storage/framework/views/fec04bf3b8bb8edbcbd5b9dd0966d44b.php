    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row flex-wrap gap-2">
                <a href="<?php echo e(route('admin.events.edit', $event->id)); ?>" style="background-color: var(--color-primary);" class="text-white px-4 py-2 rounded-md hover:opacity-90 text-center">
                    <i class="fas fa-edit mr-2"></i>Edit Event
                </a>
                <a href="<?php echo e(route('admin.events.feedbacks', $event->id)); ?>" style="background-color: #9333ea !important; color: white !important; display: inline-block !important;" class="px-4 py-2 rounded-md hover:bg-purple-700 text-center">
                    <i class="fas fa-comments mr-2"></i>View Feedbacks
                </a>
                <a href="<?php echo e(route('attendance.qr-code', $event->id)); ?>" style="background-color: #3b82f6 !important; color: white !important; display: inline-block !important;" class="px-4 py-2 rounded-md hover:bg-blue-700 text-center">
                    <i class="fas fa-qrcode mr-2"></i>View QR Code
                </a>
                <a href="<?php echo e(route('admin.events.index')); ?>" class="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 text-center">
    ...
    <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <?php if($event->image): ?>
                    <img class="w-full h-64 object-cover rounded-lg" src="<?php echo e($event->image_url ?? asset('storage/' . $event->image)); ?>" alt="<?php echo e($event->title); ?>">
                <?php else: ?>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 mt-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                ...
                <div class="text-center p-4 bg-green-50 rounded-lg">
                    ...
                    <div class="text-2xl font-bold text-green-600"><?php echo e($stats['attended']); ?></div>
            ...
            <div class="mt-4">
                <div class="flex justify-between text-sm mb-1">
                    ...
                    <span class="font-semibold"><?php echo e($attendanceRate); ?>%</span>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg">
                    ...
                    <div class="text-2xl font-bold text-green-600">
                        Rp <?php echo e(number_format($revenue['total'], 0, ',', '.')); ?>

                    </div>
                    <div class="text-xs text-gray-500 mt-1">
                        <?php echo e($revenue['paid_count']); ?> paid participants
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg">
                    ...
                    <div class="text-2xl font-bold text-blue-600">
                        Rp <?php echo e(number_format($revenue['organizer_earnings'], 0, ',', '.')); ?>

                    </div>
                    <div class="text-xs text-gray-500 mt-1">
                        Platform fee: Rp <?php echo e(number_format($revenue['platform_fee'], 0, ',', '.')); ?>
        ...
        <div class="mt-8">
            ...
            <div class="flex justify-between items-center mb-4">
                <h4 class="text-lg font-medium text-gray-900">Participants List (<?php echo e($participantsCollection->count()); ?>)</h4>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $participantsCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-8 w-8">
                                            <div class="h-8 w-8 rounded-full bg-gray-300 flex items-center justify-center text-white font-medium text-xs">
                                                <?php echo e(strtoupper(substr($participant->user->full_name ?? $participant->user->name ?? 'U', 0, 1))); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php if(($participant->status ?? '') == 'registered'): ?> bg-yellow-100 text-yellow-800
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <?php if(($participant->is_paid ?? false)): ?>
                                        <span class="text-green-600 font-semibold">
                                            Paid - Rp <?php echo e(number_format($participant->amount_paid ?? 0, 0, ',', '.')); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e(isset($participant->registered_at) ? \Carbon\Carbon::parse($participant->registered_at)->format('M d, Y h:i A') : (isset($participant->created_at) ? \Carbon\Carbon::parse($participant->created_at)->format('M d, Y h:i A') : '-')); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e(isset($participant->attended_at) ? \Carbon\Carbon::parse($participant->attended_at)->format('M d, Y h:i A') : '-'); ?>
...
function exportParticipants() {
    ...
    const participants = <?php echo json_encode($participants, 15, 512) ?>;
    const eventTitle = "<?php echo e($event->title); ?>";
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Study\Kuliah\Semester-7\CP\event-connect\resources\views/admin/events/show.blade.php ENDPATH**/ ?>